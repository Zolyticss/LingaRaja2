...
const LG_PHOTOS = {
  ...
  faucet: [
    30560253, 12040632, 10099095, 12196323, 861414, 34295404, 3616761, 15409476,
    11680481,
  ].map(lgPexels),
  tmtbar: [
    10932215, 46167, 11891953, 5623179, 10059199, 4674424, 36050289, 36815365,
    35598610, 35598611, 29299824,
  ].map(lgPexels),
  pvcprofile: [
    8983882, 2290609, 9246507, 34413871, 9678163, 17306481, 19854739, 5900792,
    18152384,
  ].map(lgPexels),
